  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 w-full max-w-full overflow-x-hidden font-sans">
      <div className="w-full">
        ...
        {/* CONTEÚDO PRINCIPAL (LAYOUT EM LINHA FRONTAL) */}
        <div className="grid gap-6 lg:grid-cols-4">
          
          {/* TABELA DE SKUs (OCUPA 3 COLUNAS SE A TELA FOR GIGANTE, MAS COMPORTA LARGURA FLUIDA) */}
                  ...
                  <tbody className="divide-y divide-gray-100 bg-white">
                    {loading ? (
                      ...
                      data.map((item, idx) => {
                        ...
                        const avg = item.daily_sales_30d_avg ?? "—";
        ...
        {/* ========================================================================= */}
        {/* INTERFACE DO CHAT FLUTUANTE DA IA (FIXED) */}
        {/* ========================================================================= */}

        {/* BOTÃO REDONDO FLUTUANTE DA IA */}
        <button
              ...
              {messages.length === 0 ? (
                <div className="text-center py-8 px-4">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Estou munido com a análise de risco do seu estoque. Pode me perguntar sobre os SKUs mais críticos ou diagnósticos das categorias!
                  </p>
                </div>
              ) : (
                messages.map((m, i) => (
